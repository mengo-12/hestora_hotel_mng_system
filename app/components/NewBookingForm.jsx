...
//             <h2 className="text-xl font-bold mb-6 text-gray-800">إضافة حجز جديد</h2>
//             <form className="grid grid-cols-1 md:grid-cols-3 gap-4">
//                 <div className="flex flex-col">
//                     <label htmlFor="bookingStatus" className="mb-1 text-gray-700 font-semibold">
//                         حالة الحجز
//                     </label>
//                     <input
//                         id="bookingStatus"
//                         placeholder="حالة الحجز"
//                         className="border border-gray-300 p-3 rounded-lg bg-gray-50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                     />
//                 </div>

//                 <div className="flex flex-col">
//                     <label htmlFor="paymentStatus" className="mb-1 text-gray-700 font-semibold">
//                         حالة الدفع
//                     </label>
//                     <input
//                         id="paymentStatus"
...
//                 <div className="flex flex-col">
//                     <label htmlFor="paymentType" className="mb-1 text-gray-700 font-semibold">
//                         نوع الدفع
//                     </label>
//                     <input
//                         id="paymentType"
...
//                 <div className="flex flex-col">
//                     <label htmlFor="bookingSource" className="mb-1 text-gray-700 font-semibold">
//                         مصدر الحجز
//                     </label>
//                     <input
//                         id="bookingSource"
//                         placeholder="مصدر الحجز"
//                         className="border border-gray-300 p-3 rounded-lg bg-gray-50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                     />
//                 </div>

//                 <div className="flex flex-col md:col-span-3">
//                     <label htmlFor="notes" className="mb-1 text-gray-700 font-semibold">
//                         ملاحظات
//                     </label>
//                     <textarea
//                         id="notes"
...
//                     </button>
//                     {guest && (
//                         <div className="mt-3 text-sm text-green-700 bg-green-100 px-3 py-1 rounded">
//                             ✅ {guest.firstName} {guest.lastName} تمت إضافته
//                         </div>
//                     )}
//                 </div>
