...
//                         <label>Adults</label>
//                         <input type="number" min={1} name="adults" value={form.adults || 1} onChange={handleChange} className="w-full border rounded p-1" />
//                         <label>Children</label>
//                         <input type="number" min={0} name="children" value={form.children || 0} onChange={handleChange} className="w-full border rounded p-1" />
