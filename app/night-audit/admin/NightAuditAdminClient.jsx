        ...
        <div className={`${darkMode?"bg-gray-900 text-white min-h-screen":"bg-white text-black"} p-6`}>
            ...
            {summary && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="p-3 rounded shadow bg-blue-100 dark:bg-blue-900">
                        <div className="text-sm">Rooms Sold</div>
                        <div className="text-xl font-bold">{summary.roomsSold}</div>
                    </div>
                    <div className="p-3 rounded shadow bg-green-100 dark:bg-green-900">
                        <div className="text-sm">Occupancy</div>
                        <div className="text-xl font-bold">{summary.occupancy}%</div>
                    </div>
                    <div className="p-3 rounded shadow bg-yellow-100 dark:bg-yellow-800">
                        <div className="text-sm">ADR</div>
                        <div className="text-xl font-bold">{summary.adr}</div>
                    </div>
                    <div className="p-3 rounded shadow bg-purple-100 dark:bg-purple-900">
                        <div className="text-sm">RevPAR</div>
                        <div className="text-xl font-bold">{summary.revpar}</div>
                    </div>
                </div>
            )}
                            ...
                            <div key={b.id} className={`${darkMode ? "bg-gray-800 text-white" : "bg-gray-100"} p-4 rounded shadow`}>
                                <div className="flex justify-between items-center mb-2">
                                    <div>
                                        ...
                                        <div className="text-sm">Guest: {guestName} • Status: {b.status}</div>
                                    </div>
